...
sudo mv ./info.php /var/www/wordpress/
sudo chown nginx:nginx /var/www/wordpress/info.php
...
sudo cp wp-config-sample.php wp-config2.php
sudo sed -i 's/database_name_here/dbeduvialwp/g' /var/www/wordpress/wp-config2.php
sudo sed -i 's/username_here/dbeduvialwpuser1/g' /var/www/wordpress/wp-config2.php
sudo sed -i 's/password_here/explorauser1/g' /var/www/wordpress/wp-config2.php
